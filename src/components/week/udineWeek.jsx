...
const getWeek = () => {
  fetch(
    "http://api.openweathermap.org/data/2.5/forecast?lat=46.0619&lon=13.2422&units=metric&cnt=7&appid=30cd7a47ee781f7844f9d35ff36ba733"
  )
    .then((res) => {
      if (res.ok) {
        return res.json();
