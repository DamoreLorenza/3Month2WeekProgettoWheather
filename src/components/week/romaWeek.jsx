...
const getWeek = () => {
  fetch(
    "http://api.openweathermap.org/data/2.5/forecast?lat=43.2128&lon=-75.4557&units=metric&cnt=7&appid=30cd7a47ee781f7844f9d35ff36ba733"
  )
    .then((res) => {
      if (res.ok) {
        return res.json();
